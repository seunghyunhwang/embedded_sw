...
__SYSCALL(__NR_init_stack, sys_init_stack)
#define __NR_push_data 452
__SYSCALL(__NR_push_data, sys_push_data)
#define __NR_pop_data 453
__SYSCALL(__NR_pop_data, sys_pop_data)

#define __NR_enqueue_syscall 454
__SYSCALL(__NR_enqueue_syscall, sys_enqueue_syscall)
#define __NR_dequeue_syscall 455
__SYSCALL(__NR_dequeue_syscall, sys_dequeue_syscall)

#define __NR_new_syscall 456
